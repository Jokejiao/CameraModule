...
//        isMirror = builder.isMirror
     ...
     */
    private fun startPreviewAndFetch() {
...
//        val bufferRect = RectF(0f, 0f, viewHeight.toFloat(), viewWidth.toFloat())
     ...
     */
    fun setPreviewOn(textureView: AutoFitTextureView?/*, fixedWidth: Boolean = true, fixedHeight: Boolean = false*/) {
        if (textureView == null) {
...
//            previewRequestBuilder.addTarget(imageReader?.surface)
    ...
    companion object {
        ...
        @JvmStatic private fun chooseOptimalSize(
            ...
            val isNormalRotate = additionalRotation == null || (additionalRotation % 180 == 0)
